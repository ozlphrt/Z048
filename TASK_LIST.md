...
## Active
- [x] Acceptance Criterion 1: Gameplay core (web)
...
- [ ] AC1 — Core gameplay UX (current focus)
  - [ ] Implement shared 2048 logic engine.
  - [ ] Wire React context/hooks for game state.
  - [ ] Build glassmorphic UI with keyboard + swipe support.
